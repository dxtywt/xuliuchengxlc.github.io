...
行间公式:<code>$$ 行间公式 $$</code>; 行内公式:<code>$ 行内公式. $</code>
...
现在一种很方便的方式便是使用ctex包即可，`\usepackage{ctex}`。
 
如果使用xeCJK宏包，稍微麻烦一点，还要设置字体名称。 
...
- 查看宏包说明
  比如我装的TeXLive2015在C://texlive目录下，打开C://texlive/2015/doc.html，你就会发现各种文档。请**仔细阅读一遍ctex.pdf**会很有用。
